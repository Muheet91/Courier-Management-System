...
if(isset($_POST['btnsign'])) {
    ...
    if($pass == $cpass) {
        $q = "INSERT INTO signup(Name, Email, Password) VALUES('$name', '$email', '$pass')";
    ...
    <div class="wrapper">
        <div class="title-text">
            ...
            <div class="form-inner">
                <form action="" class="signup" method="post" name="fms">
                    <div class="field">
                    ...
                    <div class="pass-link" style="margin-top: 20px;"><p>did you have an account ? <a href="login.php">Login</a></p></div>
                    <div class="field btn">
                        <div class="btn-layer"></div>
                        <input type="submit" name="btnsign" onclick="validsign()">
                    </div>
                </form>
            </div>
        </div>
