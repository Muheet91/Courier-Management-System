...
?>
                ...
                <td>
                <a class="btn btn-danger" href="tylog.php?dlt=<?php echo $row['Id']?>"><i class="fa-solid fa-x fa-sm"></i></a>
                </td>   
...
?>
    ...
    <div class="row">
        <div class="col-md-12">
            <h1 class="text-center mt-5"><?php echo @$message ?></h1>
        </div>
    </div>
</div>
...
$q="SELECT * FROM parcels ORDER BY Id DESC LIMIT 1" ;
$result = mysqli_query($conn, $q);
...
?>
          ...
          <div class="container my-5 ">
            <div class="row mt-5">
               ...
               <h1>THANK YOU!</h1>
               <h2 class="mt-5 ">Your Tracking Id is : <?php  echo "COUR".$row['Id']    ?></h2>
                </div>
            </div>
          </div>
