      ...
      if(isset($_POST['btnlog']))
      {
          ...
          $pass=$_POST['upass'];
           ...
           if($name == "admin" && $pass == "admin")
           {
            ...
            echo '<div class="alert text-center alert-danger text-center alert-dismissible fade show" role="alert">
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Login to Control Panel</h5>
                  ...
                  <form class="row g-3 needs-validation" method="post" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="password" name="upass" class="form-control" id="yourUsername" required>
                        <div class="invalid-feedback">Please enter your Password.</div>
                      </div>
                    </div>
                    
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit" name="btnlog">Login</button>
                    </div>
                  </form>
              ...
              <div class="credits">
                ...
                Designed by <a href="dashboard.php">CMS</a>
              </div>
